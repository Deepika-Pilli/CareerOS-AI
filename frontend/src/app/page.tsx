...
const features: {
...
}[] = [
  {
    ...
    href: "/resume",
    description:
      "Upload your resume and get AI-driven feedback on structure, keywords, and impact to stand out to recruiters.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Practice role-specific questions with instant feedback on clarity, confidence, and technical depth.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Get a personalized step-by-step plan from your current role to your dream position.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Identify missing skills for your target role and receive curated learning resources to close the gap.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
